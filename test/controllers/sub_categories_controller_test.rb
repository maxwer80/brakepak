...
class SubCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post :create, sub_category: { acronimo: @sub_category.acronimo, category_id: @sub_category.category_id, dimenciones: @sub_category.dimenciones, name: @sub_category.name }
    end
  ...
  test "should update sub_category" do
    patch :update, id: @sub_category, sub_category: { acronimo: @sub_category.acronimo, category_id: @sub_category.category_id, dimenciones: @sub_category.dimenciones, name: @sub_category.name }
    assert_redirected_to sub_category_path(assigns(:sub_category))
  end
